...
@SpringBootTest
internal class CrossedWiresTestFewestStepsTest: StringSpec() {
    ...
    init {
        "'R8,U5,L5,D3' and 'U7,R6,D4,L4'" {
            ...
            subject.findFewestSteps(firstWirePath, secondWirePath).shouldBe(30)
        }
        "'R75,D30,R83,U83,L12,D49,R71,U7,L72' and 'U62,R66,U55,R34,D71,R55,D58,R83'" {
            ...
            subject.findFewestSteps(firstWirePath, secondWirePath).shouldBe(610)
        }
        "'R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51' and 'U98,R91,D20,R16,D67,R40,U7,R15,U6,R7'" {
            ...
            subject.findFewestSteps(firstWirePath, secondWirePath).shouldBe(410)
        }
        "Process the file data for the shortest distance" {
            subject.findFewestStepsFromFile()
        }
    }
}