...
internal class DiagnosticProgramTest {
    ...
    @Test
    @DisplayName("'3,3,1105,-1,9,1101,0,0,12,4,12,99,1 (with an input entered of 0)' generates the output '0'")
    ...
    @Test
    @DisplayName("'3,3,1105,-1,9,1101,0,0,12,4,12,99,1 (with an input entered of 42)' generates the output '1'")
    ...
    internal fun theActualProblemFromPart1() {
        subject.processInitialInput(intCodeToProcess, "1")
    }

    @Test
    @DisplayName("The actual problem from Advent of Code, part 2")
    internal fun theActualProblemFromPart2() {
        subject.processInitialInput(intCodeToProcess, "5")
    }
